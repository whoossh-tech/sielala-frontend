      ...
      <main style={{ marginLeft: "60px" }}>
        ...
        <div className="content-container my-4">
          <div>
            ...
            {/* <br></br> */}
            <h1 style={{ textAlign: "left", marginLeft: 50, fontSize: 35 }}>
              <strong>{tenantApplicant?.brandName}</strong>
            </h1>
            ...
            <div className="container mx-auto text-left">
              <div style={{ alignContent: "center" }} className="mx-8">
                <table style={{ borderCollapse: "collapse", width: "100%", alignItems: "center", borderRadius: "15px", overflow: "hidden" }}>
                  <tbody>
                    <tr>
                      <td className="text-tertiary-90" style={{ fontWeight: "bold", backgroundColor: "#E685AE", color: "white", width: "10%", textAlign: "left" }}>
                        Brand Name :
                      </td>
                      <td style={{ color: "black", textAlign: "left", marginLeft: 20, width: "30%" }}>{tenantApplicant?.brandName}</td>
                    </tr>
                    <tr>
                      <td className="text-tertiary-90" style={{ fontWeight: "bold", backgroundColor: "#E685AE", color: "white", textAlign: "left" }}>
                        Brand Email :
                      </td>
                    ...
                    <tr>
                      ...
                      {tenantApplicant?.selectionDone === false && (
                        ...
                        <td className="text-secondary-80" style={{ textAlign: "left", marginLeft: 20 }}>
                          <b>Pending</b>
                        </td>
                      )}
                      ...
                      {tenantApplicant?.accepted === true && tenantApplicant?.selectionDone === true && (
                        ...
                        <td className="text-tertiary-80" style={{ textAlign: "left", marginLeft: 20 }}>
                          <b>Accepted</b>
                        </td>
                      )}
                      ...
                      {tenantApplicant?.accepted === false && tenantApplicant?.selectionDone === true && (
                        ...
                        <td className="text-warning-DEFAULT" style={{ textAlign: "left", marginLeft: 20 }}>
                          <b>Rejected</b>
                        </td>
                      )}
                    </tr>
              ...
              <Modal isOpen={isAcceptModalOpen} onRequestClose={closeAcceptModal} id="modal-confirmation-form">
                ...
                <br></br>
                <div>
                  <button className="button-red text-center" onClick={closeAcceptModal}>
                    Cancel
                  </button>
                  <button className="button-green text-center" onClick={confirmAccept}>
                    Confirm
                  </button>
                </div>
              </Modal>

              <Modal isOpen={isRejectModalOpen} onRequestClose={closeRejectModal} id="modal-confirmation-form">
                <h2 className="text-xl font-bold text-gray-800 text-center mb-4">Confirmation</h2>
                <p className="text-center text-gray-700">Are you sure you want reject Tenant Applicant?</p>
                <br></br>
                <div>
                  <button className="button-red text-center" onClick={closeRejectModal}>
                    Cancel
                  </button>
                  <button className="button-green text-center" onClick={confirmReject}>
                    Confirm
                  </button>
                </div>
              </Modal>
