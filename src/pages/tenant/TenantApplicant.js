...
const TenantApplicant = () => {
  ...
  const filterTenantApplicant = () => {
    ...
    return tenantApplicants.filter((TenantApplicant) => Object.values(TenantApplicant).some((value) => typeof value === "string" && value.toLowerCase().includes(search.toLowerCase())));
  };
                ...
                <table className="event-table mx-8 rounded">
                  ...
                  <tbody>
                    {tenantApplicants && tenantApplicants.length > 0 ? (
                      filterTenantApplicant().map((tenant, i) => (
                        <tr key={i}>
                          <td>
                          ...
                          {tenant.selectionDone === false && (
                            <td className="text-white">
                              <div style={{ borderRadius: "30px", padding: "13px", display: "inline-block", textAlign: "left", alignContent: "left" }} className="rounded bg-secondary-70 text-sm">
                                <b>Pending</b>
                              </div>
                            </td>
                          )}
                          ...
                          {tenant.accepted === true && tenant.selectionDone === true && (
                            <td className="text-white">
                              <div style={{ borderRadius: "30px", padding: "13px", display: "inline-block", textAlign: "left", alignContent: "left" }} className="rounded bg-tertiary-70 text-sm">
                                <b>Accepted</b>
                              </div>
                            </td>
                    ...
                    {search.trim() && filterTenantApplicant().length === 0 && (
                      <tr>
                        <td colSpan="6">No TenantApplicant match the search criteria</td>
                      </tr>
                    )}
                  </tbody>
                </table>
