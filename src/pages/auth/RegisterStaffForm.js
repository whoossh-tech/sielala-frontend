    ...
    <body>
      ...
      <main style={{ marginLeft: "60px" }}>
        ...
        <div className="content-container my-4">
          ...
          <form className="flex flex-col items-center px-4 pt-8 pb-6 mt-8 w-full text-neutral-100 bg-white rounded-2xl shadow-lg" onSubmit={(e) => onRegister(e)}>
            <div className="flex flex-col items-stretch space-y-4 mt-6 w-full">
              ...
              <div className="input-form flex flex-col space-y-1">
                ...
                <div className={`overflow-clip w-full border border-neutral-40 rounded-lg ${errors.email && "border-danger"}`}>
                  <input id="email" className="px-4 py-3 w-full focus:outline-none" placeholder="Insert Email" value={email} onChange={(e) => setEmail(e.target.value)} />
                </div>
              ...
              <div className="input-form flex flex-col space-y-1">
                ...
                <div className={`overflow-clip w-full border border-neutral-40 rounded-lg ${errors.name && "border-danger"}`}>
                  <input id="name" className="px-4 py-3 w-full focus:outline-none" placeholder="Insert Staff Name" value={name} onChange={(e) => setName(e.target.value)} />
                </div>
              ...
              <div className="input-form flex flex-col">
                ...
                <div className={`relative overflow-clip w-full border border-neutral-40 rounded-lg ${errors.role && "border-danger"}`}>
                  <select id="role" className="appearance-none px-4 py-3 w-full focus:outline-none" placeholder="Choose Role" value={role} onChange={(e) => setRole(e.target.value)}>
                ...
                {errors.role && <span className="mt-0.5 text-danger text-xs">{errors.role}</span>}
              </div>
            </div>
