...
const ForgotPasswordForm = () => {
  ...
  return (
    <div
      className="object-cover-login absolute inset-0 flex justify-center items-center"
    ...
    >
      ...
      <div className="card bg-white shadow-lg rounded-md p-8">
        <form className="flex flex-col items-left text-neutral-100" onSubmit={handleForgotPassword}>
          ...
          <div className="flex justify-between">
            <label htmlFor="username" className="text-sm" style={{ marginBottom: "5px" }}>
              Username:{" "}
            </label>
          </div>
          ...
          <div className="flex flex-col space-y-1">
            ...
            <input type="text" id="username" value={username} onChange={(e) => setUsername(e.target.value)} placeholder="Enter your username" className="input-field" style={{ marginTop: "5px" }} />
          </div>

          <br></br>

          <div className="flex justify-between">
            <label htmlFor="email" className="text-sm" style={{ marginBottom: "5px" }}>
              Email:{" "}
            </label>
          </div>
          ...
          <div className="flex justify-between">
            ...
            <input type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter your email" className="input-field" style={{ marginTop: "5px" }} />
          </div>
