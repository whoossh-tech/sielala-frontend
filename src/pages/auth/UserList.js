      ...
      <main style={{ marginLeft: "60px" }}>
        ...
        <div className="content-container my-4">
          ...
          <div className="button-field">
            <button className="button-pink" onClick={redirectToStaffRegistration}>
              + Create Account
            </button>
          </div>
          ...
          <div className="mb-3 mx-8" style={{ display: "flex", justifyContent: "center" }}>
                  ...
                  <tr key={user.userId}>
                    ...
                    <td>
                      {user.userId !== 1 ? (
                        ...
                        <button disabled className="button-green w-20">
                          Edit
                        </button>
                      )}
                      {user.userId !== 1 ? (
                        <button className="button-red w-20" onClick={() => handleDelete(user.userId)}>
                          Delete
                        </button>
                      ) : (
                        <button disabled className="button-red w-20">
                          Delete
                        </button>
                      )}
                    </td>
            ...
            <Modal isOpen={isModalOpen} onRequestClose={closeModal} id="modal-confirmation-form">
              ...
              <div>
                ...
                <button className="button-green text-center" onClick={confirmDelete}>
                  Confirm
                </button>
              </div>
              {/* </div>
