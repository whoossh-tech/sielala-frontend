        ...
        {selectedEvent && eventData.length > 0 && (
          <React.Fragment>
            ...
            <div className="button-area" style={{ display: "flex", justifyContent: "center" }}>
              <button className="button-pink" onClick={handleAddRewardButton} disabled={disableAddRewardButton}>
                + Add Reward
              </button>
              <button className="button-green" onClick={carryOutStockModal} disabled={disableCarryOutStockButton}>
                Carry Out Stock
              </button>
            </div>
          </React.Fragment>
